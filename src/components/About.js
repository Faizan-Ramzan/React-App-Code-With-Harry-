...
export default function About(props) {
	...
	if(props.mode === 'red'){
		myStyle = {
			color: props.mode === 'red'? 'white': '#dc3545',
			backgroundColor: props.mode === 'red'? '#dc3545': 'white',
		}
	}else{
		myStyle = {
			color: props.mode === 'dark'? 'white': '#272a2b',
			backgroundColor: props.mode === 'dark'? '#272a2b': 'white',
		}
	}
